...
export const downloadPayslip = async (payslip: Payslip, api: IApi): Promise<string> => { //this downloads the file from the API (mock in this case) and saves it to the device

    const fileAsString = await api.downloadFileAsString64(payslip.file.uri);
